    ...
    if (this.data.item.countj) {
      ...
      if (id == num) {
        item.show = '正确',
          ...
          item.cflag = 1;
        if (this.data.item.rightcount == 85) {
          wx.showModal({
            title: '中彩蛋啦',
